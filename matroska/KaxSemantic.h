...
DECLARE_MKX_UINTEGER(KaxVideoColourMatrixCoeffs)
};
...
DECLARE_MKX_UINTEGER(KaxVideoColourCbSubsamplingVert)
};

DECLARE_MKX_UINTEGER(KaxVideoColourChromaSitingHorz)
};

DECLARE_MKX_UINTEGER(KaxVideoColourChromaSitingVert)
};

DECLARE_MKX_UINTEGER(KaxVideoColourRange)
};

DECLARE_MKX_UINTEGER(KaxVideoColourTransferCharacteristics)
};
