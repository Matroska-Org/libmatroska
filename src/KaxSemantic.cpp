...
DEFINE_MKX_BINARY (KaxChapterTranslateID, 0x69A5, KaxChapterTranslate, "ChapterTranslateID", VERSION_MATROSKA_ONLY)
...
DEFINE_MKX_BINARY (KaxBlockAdditional, 0xA5, KaxBlockMore, "BlockAdditional", VERSION_ALL_MATROSKA)
...
DEFINE_MKX_BINARY (KaxBlockAddIDExtraData, 0x41ED, KaxBlockAdditionMapping, "BlockAddIDExtraData", VERSION_MATROSKA_SINCE_V4)
...
DEFINE_MKX_BINARY (KaxTrackTranslateTrackID, 0x66A5, KaxTrackTranslate, "TrackTranslateTrackID", VERSION_MATROSKA_ONLY)
...
DEFINE_MKX_BINARY (KaxVideoColourSpace, 0x2EB524, KaxTrackVideo, "VideoColourSpace", VERSION_MATROSKA_ONLY)
...
DEFINE_MKX_BINARY (KaxVideoProjectionPrivate, 0x7672, KaxVideoProjection, "VideoProjectionPrivate", VERSION_WEBM_SINCE_V4)
...
DEFINE_MKX_BINARY (KaxTrickTrackSegmentUID, 0xC1, KaxTrackEntry, "TrickTrackSegmentUID", VERSION_DIVX_ONLY)
...
DEFINE_MKX_BINARY (KaxTrickMasterTrackSegmentUID, 0xC4, KaxTrackEntry, "TrickMasterTrackSegmentUID", VERSION_DIVX_ONLY)
...
DEFINE_MKX_BINARY (KaxContentCompSettings, 0x4255, KaxContentCompression, "ContentCompSettings", VERSION_MATROSKA_ONLY)
...
DEFINE_MKX_BINARY (KaxContentEncKeyID, 0x47E2, KaxContentEncryption, "ContentEncKeyID", VERSION_ALL_MATROSKA)
...
DEFINE_MKX_BINARY (KaxContentSignature, 0x47E3, KaxContentEncryption, "ContentSignature", VERSION_DEPRECATED)
DEFINE_MKX_BINARY (KaxContentSigKeyID, 0x47E4, KaxContentEncryption, "ContentSigKeyID", VERSION_DEPRECATED)
...
DEFINE_MKX_BINARY (KaxChapterSegmentUID, 0x6E67, KaxChapterAtom, "ChapterSegmentUID", VERSION_MATROSKA_ONLY)
...
DEFINE_MKX_BINARY (KaxChapterProcessPrivate, 0x450D, KaxChapterProcess, "ChapterProcessPrivate", VERSION_MATROSKA_ONLY)
...
DEFINE_MKX_BINARY (KaxChapterProcessData, 0x6933, KaxChapterProcessCommand, "ChapterProcessData", VERSION_MATROSKA_ONLY)
